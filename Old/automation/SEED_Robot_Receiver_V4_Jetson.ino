...
// This is the code that works with the jetson, currently the robot has a 5V source connected to the JETSON pin so the drill and actuator don't get randomly triggered
// by floating values!!!
...
void loop() {
  ...
  if (digitalRead(JETSON) == LOW) {
    analogWrite(M_DOWN, 50);
