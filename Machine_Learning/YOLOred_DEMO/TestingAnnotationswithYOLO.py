...
'''This script does not train a model. It just looks at annotated data, and tells you some information on it. 
Useful for understanding how to use annotated data.'''


import os #needed for reading and path commands

# Path to dataset
DATASET_DIR = r"C:\UVM\SEED\SEED25\Images\Testing Annotated\YOLOredannotations" #will have to be changed on user-basis
...
def main():
    ...
    print(f"Total red: {total_dandelions}") #Print total found annotated dandelions
