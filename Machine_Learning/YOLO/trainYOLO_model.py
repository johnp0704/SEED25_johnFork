...
model.train(
    data=r"C:\UVM\SEED\SEED25_johnFork\Machine_Learning\YOLO\dandelion.yaml", #gotta change to your local repo path
    epochs=30,
    imgsz=1280,
    batch=-1, #autotune batch size based on GPU memory
    project=r"C:\UVM\SEED\SEED25_johnFork\Machine_Learning\YOLO\runs",  # base folder
