  ...
  mocap4r2_msgs__srv__CreateRigidBody_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    mocap4r2_msgs__srv__CreateRigidBody_Request * data =
      (mocap4r2_msgs__srv__CreateRigidBody_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mocap4r2_msgs__srv__CreateRigidBody_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mocap4r2_msgs__srv__CreateRigidBody_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  mocap4r2_msgs__srv__CreateRigidBody_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    mocap4r2_msgs__srv__CreateRigidBody_Response * data =
      (mocap4r2_msgs__srv__CreateRigidBody_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mocap4r2_msgs__srv__CreateRigidBody_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          mocap4r2_msgs__srv__CreateRigidBody_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
